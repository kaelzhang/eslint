 ...
 * @param {boolean} ignoreReadingBeforeInit -
 *      The value of `ignoreReadingBeforeInit` option.
 * @returns {ASTNode|null}
 *      An Identifier node if the variable should change to const.
 *      Otherwise, null.
 */
function getIdentifierIfShouldBeConst(variable, ignoreReadingBeforeInit) {
 ...
 */
function groupByDestructuring(variables, ignoreReadingBeforeInit) {
    var identifierMap = new Map();

    for (var i = 0; i < variables.length; ++i) {
        var variable = variables[i];
        var references = variable.references;
        var identifier = getIdentifierIfShouldBeConst(variable, ignoreReadingBeforeInit);
        var prevId = null;
...
module.exports = {
        ...
        schema: [
            {
                ...
                properties: {
                    ...
                    ignoreReadingBeforeInit: {type: "boolean"}
                },
    ...
    create: function(context) {
        ...
        var ignoreReadingBeforeInit = options.ignoreReadingBeforeInit === true;
        var variables = null;
        ...
        function checkVariable(variable) {
            var node = getIdentifierIfShouldBeConst(variable, ignoreReadingBeforeInit);
        ...
        return {
            ...
            "Program:exit": function() {
                if (checkingMixedDestructuring) {
                    ...
                    groupByDestructuring(variables, ignoreReadingBeforeInit)
                        .forEach(checkGroup);
                }
