...
Examples of **correct** code for the `{"ignoreReadingBeforeInit": true}` option:

```js
/*eslint prefer-const: ["error", {"ignoreReadingBeforeInit": true}]*/
/*eslint-env es6*/
...
Examples of **correct** code for the defaut `{"ignoreReadingBeforeInit": false}` option:

```js
/*eslint prefer-const: ["error", {"ignoreReadingBeforeInit": false}]*/
/*eslint-env es6*/
